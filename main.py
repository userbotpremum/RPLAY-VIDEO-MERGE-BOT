...
async def callback_handlers(bot: Client, cb: CallbackQuery):
    if "mergeNow" in cb.data:
        ...
        if Config.UPDATES_CHANNEL:
            try:
                ...
                if user.status == "kicked":
                    await cb.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/BullMovies_Team).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cb.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/BullMovies_Team).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
        await cb.message.edit(
            text=Config.START_TEXT,
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer - @BullMovies_Team", url="https://t.me/BullMovies_Team")], InlineKeyboardButton("CONTACT BOT", url="https://t.me/BullMovies_Team")], [InlineKeyboardButton("MOVIE CHANNEL", url="https://t.me/BullMovies_Team"),InlineKeyboardButton("MOVIE STICKERS", url="https://t.me/addstickers/IndianBot_1167961858_kang")], [InlineKeyboardButton("SUPPORT GROUP", url="https://t.me/BullMovies_Team")]),
            disable_web_page_preview=True
        )
